const helpers = {
  ...
  getMenu2pt0: function() {
    return `SELECT photo_url, menu_items.name AS pizza_name, toppings.name AS topping_name, menu_items.price AS menu_price, topping_categories.price AS topping_price
    FROM menu_items
